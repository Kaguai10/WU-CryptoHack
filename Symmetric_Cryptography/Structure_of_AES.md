...
><strong>Each transformation step has a defined purpose based on theoretical properties of secure ciphers established by Claude Shannon in the 1940s. We'll look closer at each of these in the following challenges.</strong>

## 
</body>
    </div>   
    </p>
      <img src="https://raw.githubusercontent.com/Kaguai10/CryptoHack/refs/heads/main/Symmetric_Cryptography/images/StructureAES.png" alt=# width=29% align="right">
    <div>
...
Resources:
  - <a href='https://www.youtube.com/watch?v=gP4PqVGudtg'> YouTube: AES Rijndael Cipher explained as a Flash animation </a>
...
flag = ''.join(chr(x) for row in matrix for x in row)
print(flag)
```
